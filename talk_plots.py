...
for D in Ds:
    ...
    hNfields = [23, 100] #[10.,23., 50., 100., 130.]
    mNfields = [41., 200.] #[10., 52., 100., 200., 293.]
    ...
    ax1.axvline(x=-6.5, ymin=0., ymax=0.75,color='royalblue', zorder=-100, ls=':')
    ax1.set_xlim(-10.5, -2.)
    ...
    #plt.savefig('M33_summary_sat_predictions_LCDM_%i.pdf'%D)
    plt.savefig('M33_summary_sat_predictions_%i_talk.pdf'%D)
    plt.savefig('M33_summary_sat_predictions_%i_talk.png'%D, dpi=300)
